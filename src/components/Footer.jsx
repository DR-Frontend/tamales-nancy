      ...
      <div className="wrapp">
         ...
         <div className="footer__contact">
            <div className="footer__contact-social">
               <a href="https://www.facebook.com/tamales.madrina.nancy/" target="_blank"><img src={facebook} alt="" /></a>
               <a href="https://api.whatsapp.com/send?phone=+5215587237751" target="_blank"><img src={whatsapp} alt="" /></a>
               <a href="https://goo.gl/maps/Z55HqGBXpmW2Sn1e6" target="_blank"><img src={maps} alt="" /></a>
            </div>

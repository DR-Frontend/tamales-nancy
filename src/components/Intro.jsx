...
const Intro = () =>(
   <div className="intro wrapp">
      <div className="intro__text">
         ...
         <p>Traemos para usted nuestros ricos y deliciciosos "Tamales de Cazuela" de nuestra querida Doña Nancy quien desde 1972 comenzó esta memorable tradición cocinando tamales para el deleite de nuestros paladares.<br /><br />
